...
<html lang="en">
  ...
  <body>
    ...
    <div id="main_container" class="container">
      ...
      <h4 id="database_label">Database</h4>  
  ...
  <script id="input_text" type="text/html">
    <div class="control-group" data-field="{{data_field}}">
      <label class="control-label">{{input_id}}</label>
        <div class="controls">
  ...
  <script id="input_hidden" type="text/html">
    <div class="control-group" style="display:none;" data-field="{{data_field}}">
      <label class="control-label" contenteditable="true">{{input_id}}</label>
      <div class="controls">
